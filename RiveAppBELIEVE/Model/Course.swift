...
var courses = [
    ...
    Course(
        ...
        subtitle: "Apply your Swift & SwiftUI knowledge by building real, quick and various applications from scratch",
    ...
    Course(
        ...
        subtitle: """
        Design and code a SwiftUI 3 app with custom layouts, animations and gestures using Xcode 13,
        SF Symbols 3, Canvas, Concurrency, Searchable and a whole lot more
        """,
